...
import 'package:drivers_app/widgets/progress_dailog.dart';
...
class _NewTripScreenState extends State<NewTripScreen> {
  ...
  getDriversLocationUpdatesAtRealTime() {
    ...
    streamSubscriptionDriverLivePositionPosition =
  ...
  updateDurationTimeAtRealTime() async {
    if (isRequestDirectionDetails == false) {
      ...
      if (rideRequestStatus == "accepted") {
        destinationLatLng =
            widget.userRideRequestDetails!.originLng; //user PickUp Location
      } else //arrived
      {
        destinationLatLng = widget
            .userRideRequestDetails!.destinationAddress; //user DropOff Location
      }
          ...
          children: [
            ...
            GoogleMap(
              ...
              onMapCreated: (GoogleMapController controller) {
                ...
                var userPickUpLatLng = widget.userRideRequestDetails!.originLng;
                        ...
                        onPressed: () async {
                          ...
                          if (rideRequestStatus == "accepted") {
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext c) => ProgressDailog(
                                message: "Loading...",
                              ),
                            );

                            await drawPolyLineFromOriginToDestination(
                                widget.userRideRequestDetails!.originLng!,
                                widget.userRideRequestDetails!.destinationLng!);

                            Navigator.pop(context);
                          }

                          //user has already sit in drivers car -start trip now- lets go now
                          ...
                          //user and drived to the dropp destination
 ...
 endTripNow() async
  {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context)=> ProgressDailog(message: "Please wait...",),
    );
    ...
    streamSubscriptionDriverLivePositionPosition!.cancel();
  ...
  saveAssignedDriverDetailsToUserRideRequest() {
    ...
    databaseReference.child("car_details").set(
        onlineDriverData.ambulance_color.toString() +
